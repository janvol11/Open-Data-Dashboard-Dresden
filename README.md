...
- **Visuelle Analysen:** Häufigkeitsverteilungen, Zeitreihen, Korrelationsmatrix mit Streudiagramm und Datenqualitätsbericht – alle gekoppelt an den Kartenausschnitt (Cross-Filtering).
